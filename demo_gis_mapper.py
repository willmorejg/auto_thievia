...
try:
    ...
    def demo_basic_functionality():
        ...
        theft_gdf = mapper.create_points_from_coordinates(theft_coordinates, theft_attributes)
    ...
    def main():
        ...
        try:
            ...
            print("   pip install geopandas pandas matplotlib folium shapely contextily")
            return 1
